...
- [Recherche sémantique — conception et lots](docs/architecture/recherche-semantique.md) : [benchmark S1 mesuré](audits/2026-09-24/search-s1.md), PostgreSQL enrichi intégré au chemin public, projection durable, secteurs entreprise, validations locales et procédure de livraison.
