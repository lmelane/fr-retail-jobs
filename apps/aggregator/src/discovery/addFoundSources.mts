...
const CANDIDATES: Candidate[] = [
  ...
  // w1 (2026-09-06) : tout le secteur WTTJ par facettes Algolia — 2 091 offres, 138 organisations, rejoué.
  // Exclusions = organisations classées « Luxe »/« Cosmétiques » par WTTJ mais hors Maisons (palaces, traiteurs, dermo-pharma, bien-être, vins, audio, agences, SaaS).
  { key: "wttj-sector", maison: "Welcome to the Jungle (Mode · Luxe · Beauté)", kind: "wttj-sector", type: "WTTJ", careersDomain: "www.welcometothejungle.com", tier: "SPECIALIST_JOBBOARD", config: { sectors: ["luxury-1", "fashion-1", "cosmetics", "jewelry-1", "mode"], organizations: ["charlotte-tilbury", "lectra"], excludeOrganizations: ["ritz-paris", "groupe-potel-et-chabot", "shangri-la-paris", "biografy", "des-gateaux-et-du-pain", "eluxtravel", "ihg", "voyage-prive", "wecasa", "5asec", "laboratoire-cooper", "expanscience", "coptis", "isispharma", "clinique-des-champs-elysees", "aesthe", "relax-massage-uk-ltd", "treatwell", "wine-services", "idealwine", "french-bloom", "devialet", "helmut-agency", "bureau-de-presse-pascale-venot", "the-agent-1", "fairly-made", "faume", "luxurynsight", "unilever", "yellowkorner-1", "les-raffineurs", "milia-matcha", "graduate"], detailConcurrency: 4, filterSector: false } },
