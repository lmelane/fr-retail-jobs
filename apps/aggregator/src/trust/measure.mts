 ...
 *
 *   DATABASE_URL=<prod> npx tsx src/trust/measure.mts
 */

import { PrismaClient } from '@prisma/client';
import { createObserver, EVALUATOR_VERSION } from './contradictions.js';
import { evaluate, MIN_EVIDENCE, type TrustLevel } from './verdict.js';
import { persistTrust } from './persist.js';
