 ...
 * l'on écartait les champs démontrés faux ? sans réseau ; lecture seule sauf --apply.
 *
 ...
 *
 *   DATABASE_URL=<prod> npx tsx scripts/trust/apply-precedence.mts [--apply]
 */

import { PrismaClient } from '@prisma/client';
import { createObserver, EVALUATOR_VERSION, OBSERVED_DIMENSIONS, type ObservedDimension } from '../../src/trust/contradictions.js';
import { evaluate, precedenceFor, type TrustLevel } from '../../src/trust/verdict.js';
import { resolveCanonicalDimensions } from '../../src/trust/resolve.js';
