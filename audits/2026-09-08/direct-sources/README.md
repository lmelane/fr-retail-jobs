...
Réparation production exécutée depuis main `d1c7f5738fe5c7a55ca42d3aca2a1472c8b322e1` après déploiement SUCCESS des trois workers de ce commit. Le web, sans changement applicatif dans ce lot, conserve son déploiement précédent. Deux Company corrigées ; invariants Oracle/cycle de vie verts. `groups-production-receipt.json` et `groups-production-after.json` attestent groupe Armand Thiery, RAW et historiques inchangés et index de recherche exact.
