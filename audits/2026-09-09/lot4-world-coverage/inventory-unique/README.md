# Inventaire de suivi unique — LOT 4 (généré le 2026-09-10T14:00Z)
...
|---|---:|---:|---:|
| Benchmark FashionJobs (libellés de découverte) | 1 653 | 1 633 | 263 |
| Rapprochement de la découverte web (2026-09-10) | 65 | 65 | 12 |
| Marques de portefeuilles de groupes (observations) | 275 | 266 | 99 |
| Candidats B6 (tenants avec lien réciproque archivé) | 33 tenants | 17 acteurs | — |
| Sociétés de production avec offres actives | 999 | 997 | — |
| Table `Source` (tous statuts) | 512 (ACTIVE 414, RETIRED 90, PAUSED 8) | 497 Maisons cataloguées | — |
| **Union dédupliquée** | — | **2 498** | 858 |
...
| … dont toutes les sources actives certifiées (contrat strict, configuration courante) | 189 |
| Acteurs FashionJobs sans aucune source active | 1 370 |
| Acteurs FashionJobs présents dans aucun autre jeu | 1 208 |
| Sociétés avec offres actives mais sans source ACTIVE (source retirée/pausée, offres héritées) | 156 |

Étapes FashionJobs (registre `audits/2026-09-09/fashionjobs-portals/ledger.json`) : RESEARCH_NOT_STARTED 742 · RESEARCH_INCOMPLETE 583 · ACTIVE_SOURCE_CANDIDATE 203 · CAREER_LINK_REVIEW_REQUIRED 64 · IDENTITY_MATCH_AMBIGUOUS 29 · OFFICIAL_PORTAL_TECHNICAL_VALIDATION_REQUIRED 12.

### Prochaine action par acteur (dérivée, pas décidée)

| Action | Acteurs |
|---|---:|
| recherche de portail officiel à mener | 1 301 |
| certifier la configuration courante des sources actives | 669 |
| contrôle live (collecte → publication) et couverture mondiale à prouver | 189 |
...
| revue manuelle (lien carrière / identité ambiguë) | 57 |
...
|---|---|
| Identité (contrat de promotion sur la configuration courante) | LEGACY_UNCERTIFIED 346 · CERTIFIED_CURRENT 68 |
| Périmètre certifié | none 358 · SINGLE_BRAND 32 · MULTI_BRAND 24 |
| Complétude selon le **dernier run de production** | NOT_PROVEN 193 · PROVEN_BY_DECLARED_TOTAL 119 · COMPLETE_FLAG_ONLY 102 |
| Énumération selon le **reçu du tracker v10** (adaptateur courant rejoué) | EXHAUSTIVE_PROVEN 389 · NOT_PROVEN 16 · NO_RECEIPT 9 |
| Collecte selon le reçu | COMPLETE 381 · NOT_PROVEN 13 · INCOMPLETE_EXPLAINED 11 · NO_RECEIPT 9 |
| **Verdict combiné** | RECEIPT_COMPLETE_PRODUCTION_RUN_DUE 254 · PROVEN_BY_DECLARED_TOTAL 119 · RECEIPT_COMPLETE 16 · NOT_PROVEN 11 · INCOMPLETE_EXPLAINED 9 · COMPLETE_FLAG_ONLY 5 |
| Statut du dernier run | OK 213 · DEGRADED 190 · NEW 10 · BROKEN 1 |
| Sources nourrissant plusieurs acteurs | 42 |
| Offres actives sous les sources ACTIVE | 76 962 (offres actives en base : 76 426) |
